defmodule PlainBenchmark.Instrumentation.ScheduledShutdown do
  use GenServer

  @me __MODULE__

  @shutdown_in Application.fetch_env!(:plain_benchmark, :shutdown_in)
  ...
  def handle_info(:shutdown, state) do
    target_module = PlainBenchmark.Supervisor
